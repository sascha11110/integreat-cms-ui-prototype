...
<ul class="relative z-10 list-reset flex border-b">
  <li class="-mb-px mr-1">
    <a class="bg-white inline-block border-l border-t border-r border-grey-light rounded-t py-2 px-4 text-grey-darkest font-semibold shadow" href="">
        <img src="images/flags/de.png" title="Deutsch" class="mr-1" />
        Deutsch
    </a>
  </li>
  <li class="mr-1">
